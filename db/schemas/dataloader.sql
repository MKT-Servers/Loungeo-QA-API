...
\COPY questions(question_id, product_id, question_body, question_date, asker_name, asker_email, reported, question_helpfulness) FROM '../data/questions.csv' WITH DELIMITER ',' CSV HEADER;

\COPY answers(answer_id, question_id, body, date, answerer_name, answerer_email, reported, helpfulness) FROM '../data/answers.csv' WITH DELIMITER ',' CSV HEADER;

\COPY photos(id, answer_id, url) FROM '../data/answers_photos.csv' WITH DELIMITER ',' CSV HEADER;
